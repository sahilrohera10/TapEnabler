    ...
    <div className="pt-16">
      <div className="w-full border-gray-300 border-t lg:w-11/12 md:w-11/12 lg:mx-auto md:mx-auto">
        ...
        {/* <div
          ...
          className="w-11/12 xl:w-full mx-auto lg:mx-0 xl:mx-0 mb-6 lg:mb-0 xl:mb-0 text-center"
        >
          <ul className="xl:flex lg:flex md:flex sm:flex justify-evenly">
            <li
              style={{ color: "white", fontWeight: "600" }}
              className="text-white text-base mb-4 sm:mb-0"
            >
              <a>Developed By : Sahil Rohera</a>
            </li>
            <li
              style={{ color: "white", fontWeight: "600" }}
              className="text-white text-base mb-4 sm:mb-0"
            >
              <a href="mailto:sahilrohera10@gmail.com">
